            ...
            [
                [
                    InlineKeyboardButton(
                        "🎧Developer🎧", url=f"https://t.me/ASHIRUMALSHAN"), 
                    InlineKeyboardButton(
                        "🎧Assistant🎧", url=f"https://t.me/UwMusicProvider")
                ],[
                    InlineKeyboardButton(
...
def map(pos):
    if(pos==1):
        ...
        button = [
            [InlineKeyboardButton("🎧Developer🎧", url=f"https://t.me/ASHIRUMALSHAN")],
...
async def ghelp(_, message: Message):
    await message.reply_text(
        f"""**👋 Hello there! I'm** [🎧 Music Provider Bot 🎧](https://telegra.ph/file/e739b156acc565e37289c.jpg)\n**🎙 I can play music in the voice chats of telegram groups & channels.**""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
